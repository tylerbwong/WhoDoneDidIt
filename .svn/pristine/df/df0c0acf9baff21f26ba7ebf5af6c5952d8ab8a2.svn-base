 ...
 * @author Tyler Wong
 */
public class SnoopPanel extends javax.swing.JPanel
{
    ...
    /**
     * Creates new form SnoopPanel
     */
    public SnoopPanel(MainFrame frame, JLayeredPane layerPane, List<Player> otherPlayers)
    {
        this.frame = frame;
    ...
    {
        this.frame.getController().sendSnoopAction(id);
    ...
    private void initComponents()
    {
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                .add(16, 16, 16)
                .add(opponentPanel, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 464, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
